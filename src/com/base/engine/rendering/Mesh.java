...
public class Mesh {
	...
	private void calcNormals(Vertex[] vertices, int[] indices)
	{
		for(int i = 0; i < indices.length; i += 3)
		{
			...
			Vector3f dir1 = vertices[i1].getPosition().sub(vertices[i0].getPosition());
			Vector3f dir2 = vertices[i2].getPosition().sub(vertices[i0].getPosition());
			
			Vector3f normal = dir1.cross(dir2).normalize();
